	...
	@Test (priority = 1, groups = {"SQL","BS_Sanity","Smoke_Firefox"})
	  public void SQL_DeleteAccount () throws SQLException, ClassNotFoundException {
	      ...
	      String dbUrl = "jdbc:mysql://notcraft3.covetytyjb4n.eu-west-1.rds.amazonaws.com";					
			...
			String query3 = "delete from bakewell.accounts Where name ='SSL 247-Test';";
	...
	*/		
	  ...
	  public void SQL_DeleteUser () throws SQLException, ClassNotFoundException {
	      ...
	      String dbUrl = "jdbc:mysql://notcraft3.covetytyjb4n.eu-west-1.rds.amazonaws.com";					
			...
			String query2 = "delete from bakewell.users Where email ='QATester2@ssl247-test.com';";
...
*/
	  ...
	  public void SQL_Certificate_Order () throws SQLException, ClassNotFoundException {
	      ...
	      String dbUrl = "jdbc:mysql://notcraft3.covetytyjb4n.eu-west-1.rds.amazonaws.com";					
			...
			//Query to Execute		
			//String query = "select *  from bakewell_staging_go.accounts Where account_code ='QUAL017';";	
			String query2 = "delete from bakewell.certificates Where common_name ='ssl247.co.uk';";
			
			String query3 = "delete from bakewell.certificates Where common_name ='ssl247-test.co.uk';";
	  ...
	  public void SQL_DomainName_Order () throws SQLException, ClassNotFoundException {
	      ...
	      String dbUrl = "jdbc:mysql://notcraft3.covetytyjb4n.eu-west-1.rds.amazonaws.com";					
			...
			//Query to Execute		
			//String query = "select *  from bakewell_staging_go.accounts Where account_code ='QUAL017';";	
			String query2 = "delete from bakewell.domain_names where domain_name = 'ssl247test.net';";
	  ...
	  public void Delete_User() throws SQLException, ClassNotFoundException {
	      ...
	      String dbUrl = "jdbc:mysql://notcraft3.covetytyjb4n.eu-west-1.rds.amazonaws.com";					
			...
			//Query to Execute		
			//String query = "select *  from bakewell_staging_go.accounts Where account_code ='QUAL017';";	
			String query1 = "delete from bakewell.users where lastname = 'Ogunleye1';";
			String query2 = "delete from bakewell.users where lastname = 'Ogunleye2';";
