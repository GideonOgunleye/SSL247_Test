...
public class Test_Build extends BrowserStack {
	...
	Client_IncompleteCertificatesPage IncompleteCertificaesPageElements;
	Client_CertificateValidationPage CertificateValidationPageElements;
	Client_IncompleteSmimePage IncompleteSmimePageElements;
	Client_SmimeValidationPage SmimeValidationPageElements;
	Client_IncompleteCodeSigningCertsPage IncompleteCodeSigningCertsPageElements;
	Client_CodeSigningCertsValidationPage CodeSigningCertsValidationPageElements;
	...
	public void User_Login () throws Exception {
		...
		IncompleteCertificaesPageElements = new Client_IncompleteCertificatesPage(driver);
		CertificateValidationPageElements = new Client_CertificateValidationPage(driver);
		IncompleteSmimePageElements = new Client_IncompleteSmimePage(driver);
		SmimeValidationPageElements = new Client_SmimeValidationPage(driver);
		CodeSigningCertsValidationPageElements = new Client_CodeSigningCertsValidationPage(driver);
		IncompleteCodeSigningCertsPageElements = new Client_IncompleteCodeSigningCertsPage(driver);
	...
	try {	
			CertificateValidationPageElements.CertificatesDetailsTabClick();
		    driver.manage().timeouts().implicitlyWait(40, TimeUnit.SECONDS);
