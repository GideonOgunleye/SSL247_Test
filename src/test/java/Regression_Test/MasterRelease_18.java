...
public class MasterRelease_18 extends BrowserStack {
	...
	Admin_NavigationLinks AdminNavigationLinksElements;
  ...
  public void beforeMethod() throws Exception {
	  ...
	  AdminNavigationLinksElements = new Admin_NavigationLinks(driver);
  ...
  public void HackAdvertOption_Not_Available() throws Exception {
	  ...
	  Admin_SslDashBoardElements.ExternalLinkClick();
	  driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
	  ...
	  try{	  
		  ...
		  Admin_SslDashBoardElements.ThirdCertDropDown(); 
		  driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
	  ...
	  try{	  
		  ...
		  Admin_SslDashBoardElements.FourthCertDropDown(); 
		  driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		  String path = ScreenShot.Image(driver, "SearchResult");
		  String imagePath = test.addScreenCapture(path);
	  ...
	  try{	  
		  ...
		  Admin_SslDashBoardElements.FifthCertDropDown(); 
		  driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		  String path = ScreenShot.Image(driver, "SearchResult");
		  String imagePath = test.addScreenCapture(path);
  ...
  public void Bulk_Edit_AdminContact () throws Exception {
	  ...
	  Admin_SslDashBoardElements.SearchLinkClick();
	  driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
	  test.log(LogStatus.INFO, "Clicked on Search Link");
	  
	  
	  //Click on Bulk Edit Contacts Button 
	  Admin_SslDashBoardElements.BulkEditContactsButtonClick();
	  driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
	...
	try {  
	  ...
	  Admin_SslDashBoardElements.AdminContactCheckboxClick();
	  driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
	  test.log(LogStatus.INFO, "Clicked on Admin Contact Checkbox");	  
	  
	  Admin_SslDashBoardElements.ContactFieldSelect("Gideon Ogunleye");
	  driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
	  test.log(LogStatus.INFO, "Selected Name From Contact Field");	
	  
	  Admin_SslDashBoardElements.RegionFieldFill("London");
	  driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
	  test.log(LogStatus.INFO, "Filled Region Field");	
	  
	  Admin_SslDashBoardElements.UpdateCertificateButtonClick();
	  driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
	...
	public void Validate_UserTitle () throws Exception {
		...
		Admin_SslDashBoardElements.IncompleteLinkClick();
		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		test.log(LogStatus.INFO, "Clicked on Incomplete Link");
		
		//Click on First Cert on the top of list
		Admin_SslDashBoardElements.FirstCertEditIconClick();
		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		...
		//Click on Admin Tab
		Admin_SslDashBoardElements.AdminTabClick();
		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		...
		Admin_SslDashBoardElements.AccountAdminContactFieldSelect("Rosanna Bullivant");
		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		...
		try {
			...
			if (Admin_SslDashBoardElements.MissTitleIsDisplayed()) {
				...
				driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
				Admin_SslDashBoardElements.AdminTitleTextPrint();
				test.log(LogStatus.FAIL, "Validation Failed");
...
public void Bulk_Trasfer_Certifictes (String Adusername, String Adpassword, String Url, String Account, String Account2) throws Exception {
	...
	//Load Browser
  	...
  	try {
  		...
  		Admin_SslDashBoardElements.BulkTransferCertificateButtonClick();
  		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
  		test.log(LogStatus.INFO, "Clicked on Bulk Tranfer Certificates Button");
  		
  		//Click On Issued Tab
  		Admin_SslDashBoardElements.IssuedTabClick();
  		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
  		test.log(LogStatus.INFO, "Clicked on Issued Tab");
  		
  		//Tick to Select First Two Certs
  		Admin_SslDashBoardElements.CheckBoxOneClick();
  		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
  		test.log(LogStatus.INFO, "Ticked First Cert ");

  		Admin_SslDashBoardElements.CheckBoxTwoClick();
  		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
  		test.log(LogStatus.INFO, "Ticked Second Cert ");
  		
  		//Enter Account in Search Field
  		Admin_SslDashBoardElements.SearchAccountFieldSendKeys(Account2);
  		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
  		test.log(LogStatus.INFO, "Searched Account Code");
  		
  		Thread.sleep(1000);
  	
  		if (Admin_SslDashBoardElements.ResultContains(Account2)) {
  			
  			Admin_SslDashBoardElements.ResultClick();
  			driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
  			...
  			Admin_SslDashBoardElements.TransferCertificatesButtonClick();
  			driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
