...
public class Order_Products_TB extends BrowserStack {
  ...
  try {		
		...
		if (Client_MyProductsPageElements.Link1Contains(ProductLink)) {
				
				System.out.println(ProductLink + " Found");
				Client_MyProductsPageElements.Link1_Button1Clink();
				test.log(LogStatus.INFO, "Product Page Opened");
			
			}else if (Client_MyProductsPageElements.Link2Contains(ProductLink)) {
				
				System.out.println(ProductLink + " Found");
				driver.findElement(By.xpath(".//*[@id='SSLCertificate']/table/tbody/tr[2]/td[2]/a")).click();
				test.log(LogStatus.INFO, "Product Page Opened");
		
			}else if (Client_MyProductsPageElements.Link3Contains(ProductLink)) {
				
				System.out.println(ProductLink + " Found");
				driver.findElement(By.xpath(".//*[@id='SSLCertificate']/table/tbody/tr[3]/td[2]/a")).click();
				test.log(LogStatus.INFO, "Product Page Opened");
				
			}else if (Client_MyProductsPageElements.Link4Contains(ProductLink)) {
				
				System.out.println(ProductLink + " Found");
				driver.findElement(By.xpath(".//*[@id='SSLCertificate']/table/tbody/tr[4]/td[2]/a")).click();
				test.log(LogStatus.INFO, "Product Page Opened");
			
			}else if (Client_MyProductsPageElements.Link5Contains(ProductLink)) {
				
				System.out.println(ProductLink + " Found");
				driver.findElement(By.xpath(".//*[@id='SSLCertificate']/table/tbody/tr[5]/td[2]/a")).click();
				test.log(LogStatus.INFO, "Product Page Opened");
			
			}else if (Client_MyProductsPageElements.Link6Contains(ProductLink)) {
			...
			}else if (Client_MyProductsPageElements.Link7Contains(ProductLink)) {
				
				System.out.println(ProductLink + " Found");
				driver.findElement(By.xpath(".//*[@id='SSLCertificate']/table/tbody/tr[7]/td[2]/a")).click();
				test.log(LogStatus.INFO, "Product Page Opened");
		
			}else if (Client_MyProductsPageElements.Link8Contains(ProductLink)) {
			...
			}else if (Client_MyProductsPageElements.Link9Contains(ProductLink)) {
				
				System.out.println(ProductLink + " Found");
				driver.findElement(By.xpath(".//*[@id='SSLCertificate']/table/tbody/tr[9]/td[2]/a")).click();
				test.log(LogStatus.INFO, "Product Page Opened");
		
			}else if (Client_MyProductsPageElements.Link10Contains(ProductLink)) {
				
				System.out.println(ProductLink + " Found");
				driver.findElement(By.xpath(".//*[@id='SSLCertificate']/table/tbody/tr[10]/td[2]/a")).click();
				test.log(LogStatus.INFO, "Product Page Opened");
				
			}else if (Client_MyProductsPageElements.Link11Contains(ProductLink)) {
